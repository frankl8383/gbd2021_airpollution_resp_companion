...
Age-standardized trends alone may misrepresent East Asia's air pollution-attributable respiratory burden because demographic aging and vulnerability shifts can alter counts. We examined PM2.5-attributable chronic obstructive pulmonary disease (COPD), PM2.5-attributable lower respiratory infections (LRI), and ozone-attributable COPD in GBD 2021.
...
Under prespecified 0-versus-1-break comparisons, all 36 analyzed age-standardized series preferred one breakpoint. For PM2.5-attributable COPD deaths ASR, China and East Asia shifted from earlier increases to later declines after a 2009 breakpoint, while ozone-attributable COPD deaths ASR shifted around 2007. Aging pushed COPD burden counts upward in China and East Asia, whereas underlying disease-rate change pushed downward; PAF change amplified PM2.5-attributable COPD increases but reinforced decline for ozone-attributable COPD DALYs. For PM2.5-attributable LRI deaths, the under-5 share fell from 67.2% to 2.9% in China and from 66.2% to 2.8% in East Asia, while the global comparator remained higher in 2021 (23.1%). By 2021, the age-70-plus group dominated COPD DALY burden in East Asia for both PM2.5 and ozone. Sensitivity analyses preserved the main qualitative patterns, capped versus uncapped PAF gave identical results, and the common-age-set rerun preserved COPD-death net changes, with the largest differences concentrated in population-growth and aging components and smaller corresponding shifts in the underlying-rate and PAF components.
